...
int main(int argc, char** argv) {
    ...
    const uint8_t m4[] = {"abcdefghbcdefghicdefghijdefghijkefghijklfghijklmghijklmnhijklmnoijklmnopjklmnopqklmnopqrlmnopqrsmnopqrstnopqrstu"};
    ...
    // hash.Init();
    // hash.Update(std::vector<uint8_t>(1000000, 'a'));
    // hash.Final(digest);
